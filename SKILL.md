---
name: ausgleich
description: 两人 AA 记账与结算。上传一批支付凭证截图（微信支付/支付宝/银行卡/香港电子钱包），逐张识别事项、日期、币种、金额，写入一份飞书多维表格（含原图附件），表格用公式自解算出谁该转给谁多少人民币。两个人各用各的飞书、各跑各的 agent，往同一个账本里记。触发词：A钱、AA 记账、ausgleich、平账、分账、对账、室友记账、分账表。
agent_created: true
---
